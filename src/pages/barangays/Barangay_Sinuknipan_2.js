...
const fetchData = async () => {
  try {
    const selectedBarangay = "Sinuknipan 2"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay Sinuknipan 2.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay Sinuknipan 2.csv";
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="title">
          <h1>Barangay Sinuknipan 2 Records</h1>
        </div>
