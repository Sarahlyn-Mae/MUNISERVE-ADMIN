...
const fetchData = async () => {
  try {
    const selectedBarangay = "Bagong Silang"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay Bagong Silang.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay Bagong Silang.csv";
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="title">
          <h1>Barangay Bagong Silang Records</h1>
        </div>
