...
const fetchData = async () => {
  try {
    const selectedBarangay = "Comadogcadog"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay Comadogcadog.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay Comadogcadog.csv";
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="title">
          <h1>Barangay Comadogcadog Records</h1>
        </div>
