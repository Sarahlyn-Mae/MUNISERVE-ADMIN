...
const fetchData = async () => {
  try {
    const selectedBarangay = "Cabasag"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay Cabasag.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay Cabasag.csv";
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="title">
          <h1>Barangay Cabasag Records</h1>
        </div>
