...
const fetchData = async () => {
  try {
    const selectedBarangay = "San Juan"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay San Juan.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay San Juan.csv";
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="title">
          <h1>Barangay San Juan Records</h1>
        </div>
