...
const fetchData = async () => {
  try {
    const selectedBarangay = "Pamplona"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay Pamplona.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay Pamplona.csv";
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="title">
          <h1>Barangay Pamplona Records</h1>
        </div>
