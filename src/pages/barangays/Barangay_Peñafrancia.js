...
const fetchData = async () => {
  try {
    const selectedBarangay = "Peñafrancia"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay Peñafrancia.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay Peñafrancia.csv";
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="title">
          <h1>Barangay Peñafrancia Records</h1>
        </div>
