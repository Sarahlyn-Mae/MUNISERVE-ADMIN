...
const fetchData = async () => {
  try {
    const selectedBarangay = "Salvacion"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay Salvacion.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay Salvacion.csv";
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="title">
          <h1>Barangay Salvacion Records</h1>
        </div>
