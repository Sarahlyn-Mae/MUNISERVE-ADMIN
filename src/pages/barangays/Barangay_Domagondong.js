...
const fetchData = async () => {
  try {
    const selectedBarangay = "Domagondong"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay Domagondong.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay Domagondong.csv";
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="title">
          <h1>Barangay Domagondong Records</h1>
        </div>
