...
const fetchData = async () => {
  try {
    const selectedBarangay = "Bucal"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay Bucal.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay Bucal.csv";
