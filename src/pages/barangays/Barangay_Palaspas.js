...
const fetchData = async () => {
  try {
    const selectedBarangay = "Palaspas"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay Palaspas.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay Palaspas.csv";
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="title">
          <h1>Barangay Palaspas Records</h1>
        </div>
