...
const fetchData = async () => {
  try {
    const selectedBarangay = "San Pablo"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay San Pablo.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay San Pablo.csv";
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="title">
          <h1>Barangay San Pablo Records</h1>
        </div>
