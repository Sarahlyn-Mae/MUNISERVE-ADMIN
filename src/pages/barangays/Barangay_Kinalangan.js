...
const fetchData = async () => {
  try {
    const selectedBarangay = "Kinalangan"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay Kinalangan.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay Kinalangan.csv";
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="title">
          <h1>Barangay Kinalangan Records</h1>
        </div>
