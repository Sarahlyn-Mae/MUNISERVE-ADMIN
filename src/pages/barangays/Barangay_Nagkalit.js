...
const fetchData = async () => {
  try {
    const selectedBarangay = "Nagkalit"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay Nagkalit.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay Nagkalit.csv";
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="title">
          <h1>Barangay Nagkalit Records</h1>
        </div>
