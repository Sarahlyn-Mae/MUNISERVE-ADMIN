...
const fetchData = async () => {
  try {
    const selectedBarangay = "Sta Rita 2"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay Sta Rita 2.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay Sta Rita 2.csv";
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="title">
          <h1>Barangay Sta Rita 2 Records</h1>
        </div>
