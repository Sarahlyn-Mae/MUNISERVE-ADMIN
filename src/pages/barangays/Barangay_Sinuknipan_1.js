...
const fetchData = async () => {
  try {
    const selectedBarangay = "Sinuknipan 1"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay Sinuknipan 1.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay Sinuknipan 1.csv";
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="title">
          <h1>Barangay Sinuknipan 1 Records</h1>
        </div>
