...
const fetchData = async () => {
  try {
    const selectedBarangay = "Mansalaya"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay Mansalaya.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay Mansalaya.csv";
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="title">
          <h1>Barangay Mansalaya Records</h1>
        </div>
