...
const fetchData = async () => {
  try {
    const selectedBarangay = "Mabini"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay Mabini.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay Mabini.csv";
