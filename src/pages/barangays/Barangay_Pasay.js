...
const fetchData = async () => {
  try {
    const selectedBarangay = "Pasay"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay Pasay.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay Pasay.csv";
