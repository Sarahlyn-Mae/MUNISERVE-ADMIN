...
const fetchData = async () => {
  try {
    const selectedBarangay = "Pinagdapian"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay Pinagdapian.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay Pinagdapian.csv";
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="title">
          <h1>Barangay Pinagdapian Records</h1>
        </div>
