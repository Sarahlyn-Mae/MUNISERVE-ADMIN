...
const fetchData = async () => {
  try {
    const selectedBarangay = "Comadaycaday"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay Comadaycaday.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay Comadaycaday.csv";
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="title">
          <h1>Barangay Comadaycaday Records</h1>
        </div>
