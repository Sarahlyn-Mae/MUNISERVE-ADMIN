...
const fetchData = async () => {
  try {
    const selectedBarangay = "Poblacion Zone 2"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay Poblacion Zone 2.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay Poblacion Zone 2.csv";
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="title">
          <h1>Barangay Poblacion Zone 2 Records</h1>
        </div>
