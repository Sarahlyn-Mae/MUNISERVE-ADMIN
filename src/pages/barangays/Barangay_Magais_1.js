...
const fetchData = async () => {
  try {
    const selectedBarangay = "Magais 1"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay Magais 1.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay Magais 1.csv";
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="title">
          <h1>Barangay Magais 1 Records</h1>
        </div>
