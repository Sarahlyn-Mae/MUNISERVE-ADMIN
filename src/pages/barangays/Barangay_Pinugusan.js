...
const fetchData = async () => {
  try {
    const selectedBarangay = "Pinugusan"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay Pinugusan.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay Pinugusan.csv";
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="title">
          <h1>Barangay Pinugusan Records</h1>
        </div>
