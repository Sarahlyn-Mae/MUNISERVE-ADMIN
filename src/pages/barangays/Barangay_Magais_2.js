...
const fetchData = async () => {
  try {
    const selectedBarangay = "Magais 2"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay Magais 2.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay Magais 2.csv";
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="title">
          <h1>Barangay Magais 2 Records</h1>
        </div>
