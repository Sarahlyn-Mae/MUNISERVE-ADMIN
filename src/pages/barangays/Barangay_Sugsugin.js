...
const fetchData = async () => {
  try {
    const selectedBarangay = "Sugsugin"; // Replace with the selected barangay
  ...
  const exportDataAsPDF = () => {
    ...
    // Save the PDF
    pdfDoc.save("Barangay Sugsugin.pdf");
  };
  ...
  const exportDataAsCSV = () => {
    ...
    link.download = "Barangay Sugsugin.csv";
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <div className="title">
          <h1>Barangay Sugsugin Records</h1>
        </div>
